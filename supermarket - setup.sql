...
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (2131,5913,2,NULL);
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (2461,5043,3,15.0);
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (2461,5901,2,12.0);
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (2921,5023,3,29.37);
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (2921,5937,2,NULL);
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (2937,5913,1,NULL);
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (3001,5912,3,NULL);
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (3001,5937,2,NULL);
...
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (3081,5913,2,NULL);
...
INSERT INTO cartitem (cart_id, item_id, qty, price) VALUES (3937,5913,3,NULL);
...
CREATE VIEW shopping AS
    (SELECT 
        ...
        customer.billaddr   AS 'billing_address',
        customer.shipaddr AS 'shipping_address',
        cart.id                    AS 'cart_id',
        cart.cartdate          AS 'cart_date',
        item.id                   AS 'item_id',
        item.name             AS 'item_name',
        item.type               AS 'item_type',
        item.price              AS 'item_price',
        cartitem.qty           AS 'quantity'
    FROM
        customer
            INNER JOIN
        cart ON cart.customer_id = customer.id
            INNER JOIN
        cartitem ON cartitem.cart_id = cart.id
            INNER JOIN
        item ON item.id = cartitem.item_id)
;
